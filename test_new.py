...
# Button rects
UP_BTN     = (PANEL_X + 230, PANEL_Y + 40, 50, 40)   # Up
DOWN_BTN   = (PANEL_X + 230, PANEL_Y + 90, 50, 40)   # Down
BACK_BTN   = (PANEL_X + 20, PANEL_Y + 130, 80, 35)   # Back
...
def draw_calibration_mode(frame):
    ...
    # Instructions
    cv2.putText(overlay, "Use arrows or keys", (PANEL_X + 15, PANEL_Y + 115),
...
def draw_overlay(frame, pellets):
    ...
    # Show calibration hint when NOT in mode
    if not in_calib_mode:
        cv2.putText(frame, "Press 'c' to enter calibration mode", (10, frame.shape[0] - 15),
...
def main():
    ...
    print("\nPellet Inspector + Full GUI Calibration")
    print("=" * 60)
    print("Press 'c' → Enter calibration mode")
    print("In calibration: Click UP/DOWN or use arrow keys")
    print("Click 'BACK' to return")
